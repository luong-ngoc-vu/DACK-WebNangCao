	...
	render() {
		...
		return (
			<div style={{ display: 'flex', flexDirection: 'column', padding: '10px 0px' }}>
				...
				>
					<Text strong style={{ textAlign: 'left', fontSize: 20, marginBottom: 10 }}>
						Các yêu cầu chờ xác nhận
					</Text>
				...
				<List
					...
					renderItem={(item) => (
						<List.Item
							actions={[
								<Button icon="edit" type="primary" key="list-loadmore-edit" />,
										...
										<div className="info-personal" style={{ width: '100%', position: 'relative' }}>
											...
											>
												<Text style={{ marginRight: 10 }}>
													<Icon type="appstore" theme="twoTone" />&ensp;Chủ đề dạy:{' '}
												</Text>
								...
								description={
									...
									>
										...
										<Text strong style={{ marginBottom: 5 }}>
											<Icon type="book" theme="twoTone" />&ensp;Môn bạn chọn:{' '}
											<Tag style={{ fontSize: 16 }}>Toán</Tag>
										</Text>
										<Text strong style={{ marginBottom: 5 }}>
											<Icon type="clock-circle" theme="twoTone" />&ensp;Số giờ mỗi buổi: 2.5h/buổi
										</Text>
										<Text strong style={{ marginBottom: 5 }}>
