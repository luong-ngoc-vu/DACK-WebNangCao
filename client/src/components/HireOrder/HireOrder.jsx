...
import { Form, Typography, Button, Input, Radio, Checkbox, Modal, Row, Col, InputNumber, Select } from 'antd';
			...
			>
				<Form layout="vertical" onSubmit={this.handleSubmit} style={{ maxHeight: '100%' }}>
					<Form.Item label="Số điện thoại">
						...
						})(<InputNumber style={{ width: '50%' }} placeholder="Số điện thoại liên lạc" />)}
					</Form.Item>
					...
					<Form.Item label="Số lượng người học">
						...
						})(<InputNumber style={{ width: '50%' }} min={1} max={10} defaultValue={2} />)}
					</Form.Item>
