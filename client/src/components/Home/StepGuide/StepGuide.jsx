        ...
        <Row gutter={24}>
          <Col span={6} className="step-guide__item">
            ...
            <div className="des-step-guide">
              ...
              <Text>
                Tìm gia sư theo môn học chủ đề hay những yêu cầu của bạn
              </Text>
            </div>
          </Col>
          <Col span={6} className="step-guide__item">
            ...
            <div className="des-step-guide">
              ...
              <Text>
                Bạn hãy để lại các thông tin xác nhận muốn thuê gia sư và các
                thông tin liên quan đến giảng dạy, môn học, ngày giờ, ...
              </Text>
            </div>
          </Col>
          <Col span={6} className="step-guide__item">
            ...
            <div className="des-step-guide">
              ...
              <Text>
                Trao đổi với gia sư để nhận được các thông tin chính xác liên
                quan đến gia sư và có thể trao đổi về việc thuê gia sư
              </Text>
            </div>
          </Col>
          <Col span={6} className="step-guide__item">
            ...
            <div className="des-step-guide">
              ...
              <Text>
                Sau khi hợp đồng thuê gia sư hoàn tất hãy thanh toán để đảm bảo
                tính chắc chắn của hợp đồng, không gây nhầm lẫn cho đôi bên.
              </Text>
            </div>
          </Col>
        </Row>
