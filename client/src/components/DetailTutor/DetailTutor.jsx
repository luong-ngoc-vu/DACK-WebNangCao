...
import { Col, Row, Icon, Typography, Tag, Button, Form, Input } from 'antd';
          ...
          <div className="detail-tutor__info">
            <Row className="general-info">
              <Col span={7} style={{ padding: '0px 15px 0px 0px' }}>
                ...
                <img
                  className="avatar"
                  src="https://vcdn-giaitri.vnecdn.net/2019/08/25/natra3-1566705811-8261-1566706130_1200x0.jpg"
                ></img>
              </Col>
              <Col span={17}>
                <div className="info-personal">
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 500 }}>
                      &ensp; Khu phố 6, phường 14, quận 10, Thành phố Hồ Chí
                      Minh
                    </span>
                  </Text>
