          ...
          <Layout style={{ height: '100vh' }}>
            ...
            <Layout>
              ...
              <Layout style={{ padding: '0 24px 24px' }}>
                ...
                >
                  <Route
                    path="/admin-normal/home"
                    component={ViewListUserContainer}
                  />
                  <Route
                    path="/admin-normal/detailUser"
                    component={ViewDetailUserContainer}
                  />
                  <Route
                    path="/admin-normal/createSkill"
                    component={CreateSkillContainer}
                  />
                  <Route
                    path="/admin-normal/skills"
                    component={ViewListSkillContainer}
                  />
                  <Route
                    path="/admin-normal/detailSkill"
                    component={ViewDetailSkillContainer}
                  />
                </Content>
              </Layout>
            </Layout>
