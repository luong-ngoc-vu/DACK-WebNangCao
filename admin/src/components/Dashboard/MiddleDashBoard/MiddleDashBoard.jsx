                        ...
                        <div style={{width: '100%', margin: 10}}>
                            ...
                            <Button
                                ...
                                onClick={(event) => {
                                    ...
                                    if (filterBy === 'bymonth')
                                        fetch(
                                            `https://apiadminthuegiasu.herokuapp.com/contract/getListTutorAndRevenueByMonth/${this.state
                                                .year}/${filter}`
                                        )
                                            .then((response) => response.json())
                                            .then((data) =>
                                        ...
                                        fetch(
                                            `https://apiadminthuegiasu.herokuapp.com/contract/getListTutorAndRevenueQuarter/${this.state
                                                .year}/${filter}`
                                        )
                                            .then((response) => response.json())
                                            .then((data) =>
                                        ...
                                        fetch(`https://apiadminthuegiasu.herokuapp.com/contract/getListTutorAndRevenuCurrentWeek`)
                                            .then((response) => response.json())
                                            .then((data) =>
                                                this.setState({
                                                    topThreeTutorialHighestRevenue: data
